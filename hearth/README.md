...
slideshow that exits on any remote key, direct private phone photo uploads, bulk curation and
confirmed deletion of managed uploads, plus an optional read-only Synology folder importer and
Admin status. Live managed-upload backup evidence and presence/quiet-hours

...
| Typography        | Source Sans 3 is bundled locally. TV body/action text is at least 28 logical pixels at the 1920 canvas; the 4K capture scales the entire logical canvas by two.                                                                                                           |

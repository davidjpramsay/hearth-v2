...
Playwright Chromium is used because the current toolset exposes no Browser/IAB
controller. Each concept and rendered counterpart was inspected at original
detail with `view_image`.
